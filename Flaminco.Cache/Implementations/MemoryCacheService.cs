...
namespace Flaminco.Cache.Implementations
{
    public class MemoryCacheService : ICacheService
    {
        ...
        public Task<TItem?> TryGetAsync<TItem>(RegionKey regionKey, CancellationToken cancellationToken = default)
        {
        ...
        public Task SetAsync<TItem>(RegionKey regionKey, TItem value, CancellationToken cancellationToken = default)
        {
        ...
        public Task SetAsync<TItem>(RegionKey regionKey, TItem value, TimeSpan? absoluteExpirationRelativeToNow, TimeSpan? slidingExpiration, CancellationToken cancellationToken = default)
        {
        ...
        public Task<TItem> GetOrCreateAsync<TItem>(RegionKey regionKey, Func<CancellationToken, Task<TItem>> createCallback, CancellationToken cancellationToken = default)
        {
        ...
        public Task<TItem> GetOrCreateAsync<TItem>(RegionKey regionKey, Func<CancellationToken, Task<TItem>> createCallback, TimeSpan? absoluteExpirationRelativeToNow, TimeSpan? slidingExpiration, CancellationToken cancellationToken = default)
        {
            return _memoryCache.GetOrCreateAsync(regionKey.ToString(), (entity) =>
            {
