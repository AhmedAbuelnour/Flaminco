namespace Flaminco.RediPolly.Extensions
{
    ...
    public static class RedisChannelExtensions
    {
        ...
        public static IServiceCollection AddRediPolly<TPublisherScanner>(this IServiceCollection services, string redisConnection)
        {
        ...
        {
            IEnumerable<TypeInfo> publisherTypes = typeof(TPublisherScanner)
                                                   .Assembly
                                                   .DefinedTypes
