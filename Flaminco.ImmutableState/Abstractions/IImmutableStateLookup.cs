...
namespace Flaminco.ImmutableStates.Abstractions
{
    public interface IImmutableStateLookup
    {
        ...
        /// <returns>A task that represents the asynchronous operation. The task result contains the immutable state entity, if found.</returns>
        ...
        /// <param name="cancellationToken">A token to cancel the operation.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a list of immutable state entities.</returns>
        ...
        /// </summary>
        /// <param name="cancellationToken">A token to cancel the operation.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a list of all immutable state entities.</returns>
        ...
        /// <param name="cancellationToken">A token to cancel the operation.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a list of immutable state entities that match the predicate.</returns>
        Task<List<ImmutableState>> FindByPredicateAsync(Expression<Func<ImmutableState, bool>> expression, CancellationToken cancellationToken = default);
    }
}
