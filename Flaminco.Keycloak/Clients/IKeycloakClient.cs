...
public interface IKeycloakClient
{
    ...
    ///     A dictionary of attributes to add, where the key is the attribute name and the value is a
    ///     collection of attribute values.
    /// </param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task AddAttributesToUserAsync(string userId, Dictionary<string, IEnumerable<object>> attributes,
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>
    ///     A task representing the asynchronous operation, containing the user's account information, or null if the user
    ///     is not found.
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>
    ///     A task representing the asynchronous operation, containing the user matching the attribute, or null if not
    ///     found.
    /// </returns>
    Task<KeycloakUser?> GetUserByAttributeAsync(string attributeName, string attributeValue,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>
    ///     A task representing the asynchronous operation, containing the user with the specified email, or null if not
    ///     found.
    /// </returns>
    ...
    Task<IEnumerable<KeycloakUser>> GetUsersByAttributeAsync(string attributeName, string attributeValue,
        CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<KeycloakUser>> GetUsersFromGroupAsync(string groupName,
        CancellationToken cancellationToken = default);
