...
public class KeycloakOptions
{
    ...
    {
        if (string.IsNullOrEmpty(AuthUrl)) throw new ArgumentException("AuthUrl must be set in the Keycloak options.");
        if (string.IsNullOrEmpty(Realm)) throw new ArgumentException("Realm must be set in the Keycloak options.");
        if (string.IsNullOrEmpty(Audience))
            throw new ArgumentException("Audience must be set in the Keycloak options.");

        if (string.IsNullOrEmpty(Issuer)) throw new ArgumentException("Issuer must be set in the Keycloak options.");

        if (Credentials == null) throw new ArgumentException("Credentials must be set in the Keycloak options.");
