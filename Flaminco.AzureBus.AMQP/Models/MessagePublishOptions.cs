...
public class MessagePublishOptions
{
    ...
    /// <summary>
    ///     Gets or sets the correlation identifier, which is used to correlate messages that are part of the same transaction
    ///     or context.
    /// </summary>
    ...
    /// <summary>
    ///     Gets or sets the subject or label for the message, typically used to describe the purpose or content of the
    ///     message.
    /// </summary>
