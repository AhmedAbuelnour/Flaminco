namespace Flaminco.RabbitMQ.AMQP.Attributes
{
    ...
    /// </summary>
    /// <remarks>
    ///     Initializes a new instance of the <see cref="SyncQueueConsumerAttribute"/> class with the specified queue name and message type.
    /// </remarks>
    ...
    public class SyncQueueConsumerAttribute(string queue, Type messageType) : Attribute
    {
