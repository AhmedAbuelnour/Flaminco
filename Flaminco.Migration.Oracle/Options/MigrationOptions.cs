namespace Flaminco.Migration.Oracle.Options
{
    /// <summary>
    ...
    public class MigrationOptions
    {
        ...
        /// <summary>
        /// Gets or sets the always execute directories containing the scripts that need to be executed without checking if they got executed before.
        /// </summary>
