...
//    public ProfileDownloader(string url, string directoryPath, ResumableHttpClient resumableHttpClient, string suggestedName = default)
//    {
//        Url = url;
...
//                IsResumable = await _resumableHttpClient.IsResumableAsync(Url),
//                DownloadContent = httpResponseMessage.Content.ReadAsStreamAsync(),
//                TotalReadBytes = 0
//            };
//        }
