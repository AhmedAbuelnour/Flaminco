...
//namespace Flaminco.ProDownloader.NetowrkFile;
...
//    /// </summary>
//    public List<SegmentProfileDownloader> SegmentDownloaders { get; set; }
//    /// <summary>
...
//                IsResumable = await ResumableHttpClient.IsResumable(Url),
...
//        }
//        async Task<List<SegmentProfileDownloader>> LoadSegnmentsAsync()
//        {
//            List<SegmentProfileDownloader> segments = new List<SegmentProfileDownloader>(SegmentNumbers);

//            foreach (var (Start, End) in SegmentPosition(RemoteFileProperties.Size, SegmentNumbers))
//            {
//                SegmentProfileDownloader item = new SegmentProfileDownloader(Url, Start, End);
...
//        SegmentDownloaders = new List<SegmentProfileDownloader>(Serversegs.Count);

//        foreach (var seg in Serversegs.OrderBy(e => e.Start))
//        {
//            var item = new SegmentProfileDownloader(Url, seg);
