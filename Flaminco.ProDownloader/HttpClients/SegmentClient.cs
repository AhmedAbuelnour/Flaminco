...
internal sealed class SegmentClient
{
    ...
    public async Task DownloadAsync(SegmentMetadata segment, Action<long> downloadProgressCallback, CancellationToken cancellationToken)
    {
    ...
    public async Task<Stream?> DownloadSegmentAsync(SegmentMetadata segment, CancellationToken cancellationToken = default)
    {
    ...
    public async Task WriteInPipeAsync(SegmentMetadata segment, Action<long> downloadProgressCallback, CancellationToken cancellationToken = default)
    {
        int bytesRead;
        bool firstTime = true;
