...
{
    internal sealed class ValidationPipelineBehavior<TRequest, IResult>(IEnumerable<IValidator<TRequest>> validators) : IPipelineBehavior<TRequest, IResult> where TRequest : IEndPointRequest
    {
